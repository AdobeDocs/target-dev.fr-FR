...
+ Implémentation côté client {#client-side}
   ...
   + Implémentation de Adobe Experience Platform Web SDK {#aep}
      ...
      + [Jetons de réponse d’accès](/help/dev/implement/client-side/aep-web-sdk/accessing-response-tokens.md)
      + [utiliser mbox3rdPartyId](/help/dev/implement/client-side/aep-web-sdk/using-mbox-3rdpartyid.md)
   ...
   + Implémentation d’at.js {#at-js-implementation}
      + Fonctionnement d’at.js {#at-js}
         + [Présentation de la bibliothèque JavaScript at.js](/help/dev/implement/client-side/atjs/how-atjs-works/overview.md)
         + [présentation d’at.js works](/help/dev/implement/client-side/atjs/how-atjs-works/how-atjs-works.md)
         + [Gestion du scintillement par at.js](/help/dev/implement/client-side/atjs/how-atjs-works/manage-flicker-with-atjs.md)
         + [Intégrations d’at.js](/help/dev/implement/client-side/atjs/how-atjs-works/target-atjs-integrations.md)
...
+ Implémentation côté serveur {#server-side}
   ...
   + Prise De Décision Sur L’Appareil {#on-device-decisioning}
      ...
      + [Exécuter des tests A/B avec des indicateurs de fonctionnalité](implement/server-side/sdk-guides/on-device-decisioning/execute-ab-tests-with-feature-flags.md)
...
+ Analytics for Target (A4T) avec Experience Platform SDK {#a4t}
   + [Connexion à Adobe Analytics for Target (A4T) dans Experience Platform Web SDK](/help/dev/implement/a4t/overview-a4t.md)
...
+ Modèles d’implémentation {#implementation-patterns}
   ...
   + Modèle d’implémentation de Recommendations utilisant at.js {#atjs}
      + [Modèle d’implémentation de Recommendations à l’aide d’at.js](/help/dev/patterns/recs-atjs/recs-implementation-pattern-atjs.md)
