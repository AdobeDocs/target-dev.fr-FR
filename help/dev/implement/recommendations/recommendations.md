...
Pour accéder aux options **[!UICONTROL Paramètres de recommandations]**, ouvrez Target dans le [!DNL Adobe Experience Cloud], puis cliquez sur **[!UICONTROL Recommandations]** > **[!UICONTROL Paramètres]**.
