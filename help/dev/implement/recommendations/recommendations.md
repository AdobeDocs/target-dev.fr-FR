...
[!DNL Target Recommendations] nécessite la mise en oeuvre du SDK Web Adobe Experience Platform ou d’at.js 0.9.2 (ou version ultérieure). Voir [[!UICONTROL Target] guides de mise en oeuvre côté client](../client-side/overview.md) pour plus d’informations.
...
Pour accéder au **[!UICONTROL Recommendations Settings]** options, ouvrez Target dans le [!DNL Adobe Experience Cloud], puis cliquez sur **[!UICONTROL Recommendations]** > **[!UICONTROL Settings]**.
...
|--- |--- |
| Mbox globale personnalisée | (Facultatif) Indiquez la mbox globale personnalisée utilisée pour les activités [!UICONTROL Target]. La mbox globale utilisée par défaut [!UICONTROL Target] est utilisé pour [!UICONTROL Recommendations].<P>Remarque : Cette option est définie sur la variable [!UICONTROL Target] **[!UICONTROL Administration]** page. Ouvrir [!UICONTROL Target], puis cliquez sur **[!UICONTROL Administration]** > **[!UICONTROL Visual Experience Composer]**. |
...
| [!UICONTROL Recommendations] Jeton API | Utilisez ce jeton dans [!UICONTROL Recommendations] Appels d’API, tels que l’API de téléchargement. |
