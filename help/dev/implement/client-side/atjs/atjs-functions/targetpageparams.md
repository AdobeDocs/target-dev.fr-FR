...
description: Utilisez la fonction [!UICONTROL targetPageParams()] pour la bibliothèque JavaScript at [!DNL Adobe Target] js afin de joindre des paramètres à la mbox globale depuis l’extérieur du code de requête.
