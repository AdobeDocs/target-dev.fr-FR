...
description: Utilisez la fonction [!UICONTROL mboxCreate()] pour que la bibliothèque JavaScript at [!DNL Adobe Target] js applique les offres au DIV le plus proche avec le nom de classe mboxDefault. (at.js 1.x)
