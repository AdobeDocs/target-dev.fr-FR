...
>[!WARNING]
>
>Avant de modifier ces paramètres par défaut, consultez le [service à la clientèle](https://experienceleague.adobe.com/docs/target/using/cmp-resources-and-contact-information.html?lang=fr#reference_ACA3391A00EF467B87930A450050077C) afin de ne pas affecter votre mise en oeuvre actuelle.
