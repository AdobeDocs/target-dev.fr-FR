...
Une réponse réussie contient un objet de réponse [!UICONTROL API de diffusion Target], qui contient du contenu prérécupéré pour les mbox demandées. Voici un exemple d’objet `targetResponse.response` :
