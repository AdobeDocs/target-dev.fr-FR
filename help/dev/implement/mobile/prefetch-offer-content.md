...
* **iOS:** [Prérécupération du contenu d’offre dans iOS](https://experienceleague.adobe.com/docs/mobile-services/ios/target-ios/c-mob-target-prefetch-ios.html?lang=fr) dans l’*Aide d’iOS SDK pour Mobile Services*.
* **Android:** [Prérécupération du contenu d’offre dans Android](https://experienceleague.adobe.com/docs/mobile-services/android/target-android/c-mob-target-prefetch-android.html?lang=fr) dans l’*Aide d’Android SDK pour Mobile Services*.
