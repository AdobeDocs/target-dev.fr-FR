...
description: En savoir plus [!DNL Target] comportement des cookies (cookie propriétaire, cookie tiers avec cookie propriétaire ou cookie tiers seul).
...
**Comment [!DNL Target] travail de suivi ?**
