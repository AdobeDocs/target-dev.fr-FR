...
Si vous avez déjà mappé des données au cours de la [Initialisation de la phase SDK](/help/dev/patterns/initialize-sdk.md), vous devez exécuter les étapes de ce diagramme si :
...
![Diagramme de collecte de données](/help/dev/patterns/assets/data-collection-diagram.png){width="600" zoomable="yes"}
...
![Configuration du diagramme de mappage des données](/help/dev/patterns/assets/cofigure-data-mapping.png){width="100" zoomable="yes"}
...
![Déclenchement du diagramme de l’API de suivi Adobe Target](/help/dev/patterns/assets/fire-track-api.png){width="100" zoomable="yes"}
